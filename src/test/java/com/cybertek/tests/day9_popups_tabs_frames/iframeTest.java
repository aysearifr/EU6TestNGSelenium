...
public class iframeTest {
    ...
    public void test1() throws InterruptedException {
        ...
        Thread.sleep(1000);
        driver.findElement(By.id("tinymce")).sendKeys("naber ayse");
        ...
        driver.findElement(By.id("tinymce")).clear();
        Thread.sleep(1000);
        driver.findElement(By.id("tinymce")).sendKeys("naber ayseyi index ile locate ederek yaziyorum");
        ...
        Thread.sleep(1000);
        driver.findElement(By.id("tinymce")).clear();
        driver.findElement(By.id("tinymce")).sendKeys("webelement ile  locate ettim");
        ...
        //html
            ...
            //top has 3 frame under :left, middle, right
            ...
            //go ti main html to switch bottom
            driver.switchTo().defaultContent();
